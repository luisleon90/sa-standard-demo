with part as (
    ...
    select * from analytics.dbt_lleon.stg_tpch_parts

),

supplier as (

    select * from analytics.dbt_lleon.stg_tpch_suppliers

),

part_supplier as (

    select * from analytics.dbt_lleon.stg_tpch_part_suppliers
